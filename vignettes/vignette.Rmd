---
title: "Selecting genes with L-shaped pattern from expression and methylation arrays"
...
3.  Score the selected data and return classification (scores and group) and plots for each gene.
